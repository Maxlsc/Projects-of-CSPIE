...
__m128i rol(__m128i x,int k){
    __m128i tmp1 = _mm_slli_epi32(x,k);
    __m128i tmp2 = _mm_srli_epi32(x,32-k);
    __m128i res = _mm_xor_si128(tmp1, tmp2);
    return res;
}

// __m128i rol(__m128i a, int k)
// {
// 	k = k % 32;
