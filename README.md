...
| [9 AES / SM4 software implementation](https://github.com/Maxlsc/Projects-of-CSPIE/tree/main/Project9) | 利用常见的查找表/利用SIMD AVX2指令/利用AES-NI指令集三种方法加速SM4， **AMD Ryzen 7 6800H with Radeon Graphics**下加密1024bit信息分别耗时0.0129ms/0.0041ms/0.0069ms  |                                  | **✔️**              |                    |
